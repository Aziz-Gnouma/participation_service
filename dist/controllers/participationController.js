...
exports.deleteParticipation = exports.updateParticipation = exports.getParticipationByIdAndEtat = exports.countParticipationsAnnule = exports.countParticipationsByCarpoolingIDAndEtat = exports.getParticipationsByClientId = exports.getParticipationById = exports.createParticipation = exports.getParticipations = void 0;
...
const createParticipation = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { clientID, carpoolingID, etat } = req.query;
        ...
        // Save the new participation asynchronously
        const savedParticipation = yield newParticipation.save();
        // Map the saved participation to a DTO
        const participationDTO = (0, Participation_1.mapParticipationToDTO)(savedParticipation);
        // Respond with the DTO and a 201 Created status
        return res.status(201).json(participationDTO);
    }
    catch (error) {
        // Log the error for debugging purposes
        console.error('Error creating participation:', error);
        // Respond with a 400 Bad Request status and a specific error message
...
const getParticipationsByClientId = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const clientID = req.params.id;
    try {
        console.log('Attempting to find participations for client with ID:', clientID);
        const participations = yield Participation_1.default.find({ clientID }).lean().exec();
        if (!participations || participations.length === 0) {
            console.log('No participations found for client with ID:', clientID);
...
exports.getParticipationsByClientId = getParticipationsByClientId;
